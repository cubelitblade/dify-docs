...
Add skills to hand the agent your standard procedures. For what a skill is and when to reach for one, see [Skills](/en/self-host/use-dify/build/skills/overview).
